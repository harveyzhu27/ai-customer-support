#!/usr/bin/env python3
"""
AI Assistant Evaluation Script
Evaluates the Aven Assistant for accuracy, helpfulness, and citation quality
"""
...
class AssistantEvaluator:
    def __init__(self):
        """Initialize the evaluator with API keys and configuration"""
        self.openai_api_key = os.getenv('OPENAI_API_KEY')
        self.vapi_api_key = os.getenv('NEXT_PUBLIC_VAPI_API_KEY')
        self.assistant_id = os.getenv('NEXT_PUBLIC_VAPI_ASSISTANT_ID')
    ...
    def get_assistant_response(self, question: str) -> str:
        ...
        # Simulate API call to your assistant
        try:
            # This would be your actual API endpoint
            # response = requests.post('http://localhost:3000/api/assistant', 
